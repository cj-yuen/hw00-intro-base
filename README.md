...
## Description
The aim of this project was to build an interactive WebGL application with TypeScript as an introductory lesson to familiarize students with computer graphics programming for this course. 

In steps (1) and (2), students are required to review the provided starting code and learn about TypeScript and other essential topics before getting started. 

In step (3), students needed to add a new 'Cube' class which resulted in more familiarity with the structure of the code and the relationship between main.ts and the classes in the geometry folder. 
